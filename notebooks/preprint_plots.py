...
metrics = ["correlations", "sample_wise_mse"] #, "sample_wise_mae"]
...
plot_functions = {
    ...
    "sample_wise_mse": lambda df, **kwargs: plot_error_metric(df, "sample_wise_mse", **kwargs),
    # "sample_wise_mae": lambda df, **kwargs: plot_error_metric(df, "sample_wise_mae", **kwargs),
}

df_corr = df_boxplot[df_boxplot["correlation_type"] == "sample_wise_correlation"].copy()
df_mse = df_boxplot[df_boxplot["correlation_type"] == "sample_wise_mse"].copy()
